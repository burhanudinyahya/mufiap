    ...
    <div class="movies-info border-b border-gray-800">
        <div class="container mx-auto px-4 pb-16 flex flex-col md:flex-row">
            ...
            <div class="pt-16 md:ml-12 lg:ml-24">
                ...
                <div class="mt-12">
                    <a target="_blank" href="https://www.youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" class="flex inline-flex items-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
